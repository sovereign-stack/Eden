...
def build_prompt(query, memory, docs):
    ...
    if not has_context:
        return f"""You are a helpful assistant. Use the memory of previous conversations to answer the user's question. If unsure, say so.
...
"""
        ...
        return f"""You are a helpful assistant. Use the following context and memory to answer. If the answer is directly in the context, cite it. If indirectly related, reason it out. If unclear, say you are unsure.
